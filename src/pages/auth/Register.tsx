          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              {formData.userType === 'recruteur' && (
                <div className="mt-2 rounded-lg border border-eemploi-primary bg-blue-50 p-3 flex items-center space-x-3">
                  <svg className="w-5 h-5 text-eemploi-primary flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="2" fill="none"/><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4m0 4h.01"/></svg>
                  <span className="text-eemploi-primary text-sm font-medium">
                    En tant que <span className="font-semibold">recruteur</span>, vous pourrez ajouter les informations de votre société après inscription, dans votre espace recruteur (Recruiter Hub).
                  </span>
                </div>
              )}
            </div>
